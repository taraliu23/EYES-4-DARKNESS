...
# 计划出行路线
other_loc = {'name':['北京大学人民医院白塔寺院区','什刹海街道政务服务中心','地安门桥','帽儿胡同'], 'loc':['116.366224,39.924753','116.380275,39.93399'], 'note':['出生地','工作地','1993年最后的北京行前往地安门桥下书店','1993年最后的北京行提到想去朋友居住的胡同的帽子店']}
...
def reverse_geocode():
    ...
    para = {'location':'116.361789261904747,39.933887761904771', 'key': key, 'city':'北京'}
    reqs = requests.get(base, para)
    json_info = json.loads(reqs.text)
    return json_info
